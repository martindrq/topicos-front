...
import {ListItem, ListItemText, Avatar, Divider, Grid, Typography, Box, IconButton, Paper, Tooltip, Fab, List} from '@mui/material';
...
const Home = () => {
  ...
  const element = indicators.map( (indicador) => 
